...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameApp = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function rootReducer() {
	  ...
	  switch (action.type) {
	    case _actions.DEAL_HAND:
	      (0, _socket.sendMessage)("draw_card", {});
...
/***/ function(module, exports) {
	...
	var DEAL_HAND = exports.DEAL_HAND = 'DEAL_HAND';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _phoenix = __webpack_require__(189);

	var socket = void 0,
	    channel = void 0;

	function setupSocket() {
	  socket = new _phoenix.Socket('/socket', { params: { token: window.userToken } });
	  socket.connect();
	...
	function sendMessage(msg) {
	  ...
	  channel.push(msg, params).then(function (resp) {
	    console.log(resp);
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Hand = __webpack_require__(186);

	var _Hand2 = _interopRequireDefault(_Hand);

	var _DrawCard = __webpack_require__(188);
	...
	var GameApp = function (_Component) {
	  ...
	  function GameApp(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GameApp).call(this, props));
	  }
	  ...
	  _createClass(GameApp, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'GameApp' },
	        _react2.default.createElement(_Hand2.default, { cards: this.props.hand || [] }),
	        _react2.default.createElement(_DrawCard2.default, null)
	      );
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(GameApp);
	    ...
	    value: function render() {
	      var cards = this.props.cards.map(function (card, key) {
	        return _react2.default.createElement(
	          'span',
	          { key: key },
	          _react2.default.createElement(_Card2.default, { suit: card.suit, rank: card.rank })
	        );
	      });
	      return _react2.default.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	Card.propTypes = {
	  rank: _react.PropTypes.string.isRequired,
	  suit: _react.PropTypes.string.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DrawCard = function (_Component) {
	  _inherits(DrawCard, _Component);

	  function DrawCard(props) {
	    _classCallCheck(this, DrawCard);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DrawCard).call(this, props));

	    _this.onClickDrawCard = _this.onClickDrawCard.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(DrawCard, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'button',
	        { className: 'btn btn-success', onClick: this.onClickDrawCard },
	        'Draw Card'
	      );
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)()(DrawCard);
